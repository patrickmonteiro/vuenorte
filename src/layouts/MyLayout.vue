<template>
  <q-layout view="lHh Lpr lFf">
    <q-header elevated class=" bg-vuenorte">
      <q-toolbar>
        <q-btn
          flat
          dense
    ...
    >
      <q-list>
        ...
        <q-item clickable to="/comunidade" active-class="text-green">
          <q-item-section avatar>
            <q-icon name="group" />
          </q-item-section>
          <q-item-section>
            <q-item-label>Comunidade</q-item-label>
            <q-item-label caption>Um pouco sobre nós</q-item-label>
          </q-item-section>
        </q-item>
        <q-item clickable to="/links" active-class="text-green">
          <q-item-section avatar>
            <q-icon name="link" />
          </q-item-section>
          <q-item-section>
            <q-item-label>Links</q-item-label>
            <q-item-label caption>Alguns materiais de ajuda</q-item-label>
          </q-item-section>
        </q-item>
